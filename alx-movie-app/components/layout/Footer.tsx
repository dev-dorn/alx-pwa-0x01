...
const Footer: FC<FooterProps> = (props) => {
  return (
    <footer className='bg-[#171d22] text-white pyy-10 px-6 md:px-10 lg:px-20'>
      <div className='flex flex-col md:flex-row justify-between items-center w-full'>
        <h2  className='text-xl md:text-4xl font-semibold mb-4 md:mb-0'>
          Cine<span className='text-[#E2D609]'>Seek</span>
        </h2>
        <nav className='flex-1 flex justify-center space-x-6 mb-4 md:mb-9'>
          ...
          <Link href="/contact" className='hover:text-[#E2D609] text-lg transition-colors duration-300'>Privacy Policy</Link>
